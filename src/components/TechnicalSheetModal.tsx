  ...
  useEffect(() => {
    if (song) {
      setFormData({
        ...
        isrcCode: song.technicalSheet?.isrcCode || song.isrcCode || `BR-DMK-26-${song.id.slice(0, 5).toUpperCase()}`,
        upcCode: song.technicalSheet?.upcCode || song.upcCode || `789${song.id.slice(0, 6).replace(/\D/g, '0').padEnd(9, '1')}`,
