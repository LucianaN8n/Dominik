...
Só ficou pra olhar...`,
  ...
  },
  {
    ...
    history: 'Composta por Luciana Domingos para ser uma injeção de adrenaline e foco inabalável. Combina arranjos de metais orquestrais gravados com linhas de sub-bass pesadíssimas e pontuações líricas cirúrgicas, com produção e arranjos de Dominik.',
...
O jogo muda.`,
  ...
  },
  {
    ...
    concept: 'Representa a transição de quem superou a escassez e assumiu a liderança do próprio mercado. A postura do imperador que cuida do seu império e multiplica resultados.',
    language: 'Português (Brasil)',
    bpm: 132,
    key: 'Ré Menor (Dm)',
...
O jogo muda.`,
  ...
  },
  {
    ...
    concept: 'O Efeito Magneto fala sobre a força de atração que emana de pessoas com propósito claro. Quando você trabalha no seu mais alto nível, as oportunidades gravitam naturalmente até você.',
    language: 'Português (Brasil)',
    bpm: 92,
    key: 'Lá Menor (Am)',
